  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child:
            text(widget.textContent, textColor: widget.isStroked ? grocery_colorPrimary : grocery_color_white, fontSize: textSizeMedium, isCentered: true, fontFamily: fontSemiBold, textAllCaps: true),
