                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  'Disease Symptoms',
                                  style: boldTextStyle(color: appStore.isDarkModeOn ? white : blackColor, size: 18),
                                ).center().expand(),
                                Icon(Icons.home_outlined, color: appStore.isDarkModeOn ? white : blackColor, size: 24),
                              ],
                            ).paddingAll(16.0),
                            Divider(height: 0.5),
                            16.height,
                            Text(
                              ...
                              style: boldTextStyle(size: 24, color: appStore.isDarkModeOn ? white : blackColor),
                            ).paddingOnly(left: 16),
                            8.height,
                            Text(
                              'Corona Disease',
