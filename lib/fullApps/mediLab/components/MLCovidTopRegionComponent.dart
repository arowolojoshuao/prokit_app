      ...
      children: [
        ...
        Container(
          ...
          decoration: boxDecorationWithRoundedCorners(
            backgroundColor: appStore.isDarkModeOn ? scaffoldDarkColor : mlColorGreyShade,
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Region', style: boldTextStyle(size: 12, color: appStore.isDarkModeOn ? white : blackColor)),
                  16.width,
                  Text('Actives', style: boldTextStyle(size: 12, color: appStore.isDarkModeOn ? white : blackColor)),
                  Text('Cases', style: boldTextStyle(size: 12, color: appStore.isDarkModeOn ? white : blackColor)),
                ],
              ),
              Divider(),
              Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              e.country.validate(),
                              style: boldTextStyle(size: 12, color: appStore.isDarkModeOn ? white : blackColor),
                            ),
                            16.width,
