...
Widget mAddress(BuildContext context) {
  return Container(
    ...
    decoration: BoxDecoration(borderRadius: BorderRadius.circular(50), color: appStore.isDarkModeOn ? cardDarkColor : food_colorPrimary_light),
    child: Row(
  ...
  Widget build(BuildContext context) {
    ...
    return Visibility(
      ...
      child: Container(
        ...
        alignment: Alignment.center,
        width: width * 0.23,
        decoration: BoxDecoration(color: appStore.isDarkModeOn ? scaffoldDarkColor : white, borderRadius: BorderRadius.circular(4), border: Border.all(color: food_textColorPrimary)),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            Container(
...
Widget bottomBillDetail(BuildContext context, var gColor1, var gColor2, var value, {required Function onTap}) {
  return Container(
    height: 100,
    decoration: BoxDecoration(boxShadow: defaultBoxShadow(), border: Border.all(color: white), color: context.cardColor),
