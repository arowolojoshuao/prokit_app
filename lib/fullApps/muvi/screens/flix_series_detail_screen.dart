...
class SeriesDetailScreenState extends State<SeriesDetailScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    var moviePoster = AspectRatio(
      ...
      child: Stack(
        ...
        children: [
                            ...
                            Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    text(
                                      durationFormatter(_currentPosition) + " / " + durationFormatter(_duration),
          ...
          Center(child: loadingWidgetMaker()).visible(isBuffering)
        ],
      ),
    );
    ...
    var buttons = Row(
      ...
      children: [
        IconButton(icon: Icon(Icons.thumb_up, size: 24, color: muvi_textColorPrimary), onPressed: () {}).expand(),
        IconButton(icon: Icon(Icons.playlist_add, size: 24, color: muvi_textColorPrimary), onPressed: () {}).expand(),
        IconButton(icon: Icon(Icons.cloud_download, size: 24, color: muvi_textColorPrimary), onPressed: () {}).expand(),
        IconButton(icon: Icon(Icons.share, size: 24, color: muvi_textColorPrimary), onPressed: () {}).expand(),
        IconButton(
          icon: Icon(Icons.sentiment_dissatisfied, size: 24, color: muvi_textColorPrimary),
          onPressed: () {},
        ).expand(),
      ],
    ).paddingOnly();
              ...
              SafeArea(
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      IconButton(
                        icon: Icon(Icons.arrow_back, color: muvi_colorPrimary),
                        onPressed: () {
                          if (isFullScreen) {
                            SystemChrome.setPreferredOrientations(
                              [
        ...
        AnimatedSwitcher(
          ...
          child: controller!.value.isPlaying
              ...
              : Container(
                  ...
                  child: Icon(Icons.play_arrow, color: Colors.white, size: 100.0).center(),
                ),
        ),
        GestureDetector(
          onTap: () {
