    ...
    child: Row(
      ...
      children: <Widget>[
        ...
        text(
          ...
          fontSize: ts_normal,
          fontFamily: font_medium,
          textColor: buttonTextColor == null ? Colors.black : buttonTextColor,
        ).paddingLeft(spacing_standard),
      ],
    ),
    shape: RoundedRectangleBorder(
      borderRadius: new BorderRadius.circular(spacing_control),
      side: BorderSide(width: 0.8, color: borderColor == null ? muvi_colorPrimary : borderColor),
    ),
    onPressed: callBack,
  );
}
                ...
                return Container(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => MovieDetailScreen(title: "Action")),
                      );
                    },
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            () {
              MovieDetailScreen(title: "Action").launch(context);
            },
          );
        },
      ),
