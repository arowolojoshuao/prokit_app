            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(10)), color: context.cardColor),
                ),
              ],
            ),
            16.height,
              ...
              itemBuilder: (context, index) {
                return Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(messageList[index].name!, style: boldTextStyle(size: 14)),
                        ),
                        8.height,
                        Container(
                          width: MediaQuery.of(context).size.width,
                    ...
                    Text(messageList[index].lastSeen!, style: secondaryTextStyle()),
                  ],
                ).onTap(() {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(callList[index].name!, style: boldTextStyle(size: 14)),
                          8.height,
                          Row(
                            children: [
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          icon: Image.asset(callList[index].audioCallIcon!, height: 40, width: 40),
                          onPressed: () {},
                        )
                      ],
                    ),
