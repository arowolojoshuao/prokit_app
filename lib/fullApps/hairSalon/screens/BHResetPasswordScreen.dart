            ...
            actions: [
              Container(
                ...
                child: TextButton(
                  ...
                  child: Text(BHBtnOk, style: boldTextStyle(color: appStore.isDarkModeOn ? white : BHAppTextColorSecondary)),
                ),
              ),
            ],
            content: Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  16.height,
                  Text(BHTxtCongratulation, style: boldTextStyle(color: BHColorPrimary, size: 20)),
                  16.height,
                  Text(BHAlertDialogTitle, textAlign: TextAlign.center, style: secondaryTextStyle()),
                ],
              ),
            ),
          );
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(BHTxtResetPwd, style: boldTextStyle(size: 18)),
                    16.height,
                    Text(BHResetPasswordTitle, textAlign: TextAlign.center, style: secondaryTextStyle()),
                    16.height,
                    TextFormField(
