                ...
                return SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Stack(
                        children: [
                          bmCommonCachedNetworkImage(personList[index].image, height: 50, width: 50, fit: BoxFit.cover).cornerRadiusWithClipRRect(100),
          ...
          Container(
            ...
            child: Column(
              ...
              children: personList.map((e) {
                return Row(
                  children: [
                    bmCommonCachedNetworkImage(e.image, height: 50, width: 50, fit: BoxFit.cover).cornerRadiusWithClipRRect(100),
                    8.width,
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      mainAxisSize: MainAxisSize.min,
