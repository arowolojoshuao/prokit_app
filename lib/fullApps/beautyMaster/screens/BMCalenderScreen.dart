    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Container(
            width: context.width(),
            decoration: BoxDecoration(borderRadius: radiusOnly(topRight: 32, topLeft: 32), color: appStore.isDarkModeOn ? bmSecondBackgroundColorDark : bmSecondBackgroundColorLight),
            padding: EdgeInsets.symmetric(horizontal: 16, vertical: 20),
            child: widget.isStaffBooking ? bookStaff() : bookAppointment(),
          ).expand()
        ],
      ),
