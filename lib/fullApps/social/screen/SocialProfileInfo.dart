  ...
  Widget build(BuildContext context) {
    ...
    Widget mPopup() => PopupMenuButton(
          ...
          child: Container(
              ...
              decoration: boxDecorationWithRoundedCorners(border: Border.all(color: white), borderRadius: BorderRadius.all(Radius.circular(0)), backgroundColor: Colors.transparent),
              child: Icon(
                Icons.more_vert,
        ...
        child: Row(
          children: <Widget>[
            ...
            Expanded(
              ...
              child: GestureDetector(
                  child: Container(
                decoration: boxDecoration(color: social_form_google, showShadow: true, bgColor: context.cardColor),
                padding: EdgeInsets.fromLTRB(spacing_standard, spacing_middle, spacing_standard, spacing_middle),
                child: RichText(
                  text: TextSpan(
                    children: [
              ...
              SliverAppBar(
                ...
                title: Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Center(
                        child: text(social_lbl_notifications, textColor: white, fontFamily: fontBold, fontSize: textSizeLargeMedium, textAllCaps: true),
                      ),
                      mPopup()
                    ],
                  ),
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: Container(
                    ...
                    child: Stack(
                      alignment: Alignment.bottomLeft,
                      children: <Widget>[
                        Image.network(social_ic_user1_1, width: width, fit: BoxFit.fill),
                      ],
                    ),
                  ),
                ),
