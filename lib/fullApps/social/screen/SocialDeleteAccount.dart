                                ...
                                text: TextSpan(
                                  children: [
                                    WidgetSpan(
                                      child: Padding(
                                        padding: const EdgeInsets.symmetric(horizontal: 8.0),
                                        child: Icon(Icons.call, color: appStore.isDarkModeOn ? white : social_textColorPrimary, size: 18),
                                      ),
                                    ),
                                    TextSpan(text: social_phone, style: TextStyle(color: appStore.isDarkModeOn ? white : social_textColorPrimary, fontSize: textSizeMedium)),
                                  ],
                                ),
                              ),
                            )
