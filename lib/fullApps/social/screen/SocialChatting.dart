          ...
          children: <Widget>[
            Container(
                ...
                decoration: BoxDecoration(
                  color: appStore.isDarkModeOn ? cardDarkColor : social_app_background_color,
                ...
                child: text(model.msg, textColor: appStore.isDarkModeOn ? white : social_textColorPrimary, fontSize: textSizeMedium, maxLine: 3, fontFamily: fontMedium, isLongText: true))
          ],
        );
