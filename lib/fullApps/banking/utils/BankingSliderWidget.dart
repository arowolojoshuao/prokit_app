...
class BankingCarouselSlider extends StatefulWidget {
  ...
  /// The initial page to show when first creating the [BankingCarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [BankingCarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [BankingCarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [BankingCarouselSlider].
  ///
  ...
  /// Animates the controlled [BankingCarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  @override
  _BankingCarouselSliderState createState() => _BankingCarouselSliderState();
}

class _BankingCarouselSliderState extends State<BankingCarouselSlider> with TickerProviderStateMixin {
  Timer? timer;
