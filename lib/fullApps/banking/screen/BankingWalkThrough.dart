...
import 'package:prokit_flutter/fullApps/banking/screen/BankingSignIn.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    ...
                    style: boldTextStyle(size: 20, color: Banking_TextColorPrimary, fontFamily: fontBold),
                  ),
                  10.height,
                  // Adding Button
                ],
          ...
          Positioned(
            ...
            child: Align(
              ...
              child: DotsIndicator(
                ...
                decorator: DotsDecorator(color: Banking_view_color, activeColor: Banking_Primary),
              ),
            ),
          ),
          Positioned(
