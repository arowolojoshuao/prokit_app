    ...
    var searchList = ListView.builder(
        ...
        itemBuilder: (BuildContext contxt, int index) {
          return Container(
            ...
            decoration: boxDecoration(bgColor: context.scaffoldBackgroundColor, showShadow: true),
            child: Row(
              children: <Widget>[
                Image.asset(
          ...
          Row(
            children: <Widget>[
              ...
              Container(
                ...
                decoration: boxDecoration(showShadow: true, radius: spacing_standard, bgColor: context.scaffoldBackgroundColor),
                child: Icon(
                  Icons.filter_list,
