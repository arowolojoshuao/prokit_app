...
List<SubscriptionModel> getTravelStoryDetailList() {
  ...
  travelStoryDetailList.add(SubscriptionModel(img: t14_travel5, name: 'Edwards Roberts', userImg: t14_profile1));
  ...
  travelStoryDetailList.add(SubscriptionModel(img: t14_travel6, name: 'Burton Armstrong', userImg: t14_profile1));
...
List<SubscriptionModel> getTravel3StoryDetailList() {
  ...
  travelStoryDetailList.add(SubscriptionModel(img: t14_travel10, name: 'Davies Taylor', userImg: t14_profile1, country: 'Island'));
  ...
  travelStoryDetailList.add(SubscriptionModel(img: t14_travel5, name: 'Jenkins Lawrence', userImg: t14_profile1, country: 'England'));
...
List<MessageListModel> getUserList() {
  ...
  userList.add(MessageListModel(img: t14_profile1, name: 'Edwards', isActive: true));
...
List<CheckBoxTextModel> getFinance1CheckBoxTxtList() {
  ...
  subscription4checkBoxTxtList.add(CheckBoxTextModel(name: 'Edwards Roberts', img: t14_profile1));
...
List<MessageListModel> getMessageCountList() {
  ...
  messageCountList.add(
    MessageListModel(img: t14_profile1, name: 'Edwards Roberts', message: 'my dear friends', lastSeen: "5", isActive: false),
  );
  messageCountList.add(
  ...
  messageCountList.add(
    MessageListModel(img: t14_profile1, name: 'Jenkins Lawrence', message: 'I am so happy', lastSeen: "22", isActive: true),
  );
...
List<MessageListModel> getMessageList() {
  ...
  messageList.add(
    MessageListModel(img: t14_profile1, name: 'Edwards Roberts', message: 'my dear friends', lastSeen: "10:17", isActive: true),
  );
  messageList.add(
    MessageListModel(img: t14_profile1, name: 'Edwards Roberts', message: 'I like these sweet morning of', lastSeen: "10:17", isActive: true),
  );
  messageList.add(
  ...
  messageList.add(
    MessageListModel(img: t14_profile1, name: 'Edwards Roberts', message: 'I enjoy with whole heart', lastSeen: "10:17", isActive: true),
  );
  messageList.add(
