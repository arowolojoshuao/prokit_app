                      ...
                      child: Column(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: commonCachedNetworkImage(data.img!, width: 210, height: 220, fit: BoxFit.cover),
                          ),
                          8.height,
                    ...
                    return Container(
                      ...
                      child: Stack(
                        children: [
                          ClipRRect(
                            borderRadius: BorderRadius.all(Radius.circular(15)),
                            child: commonCachedNetworkImage(data.img!, width: 150, height: 200, fit: BoxFit.cover),
                          ),
                          8.height,
                          Positioned(
                            top: 8,
