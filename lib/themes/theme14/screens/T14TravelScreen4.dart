            ...
            return Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: commonCachedNetworkImage(data.img!, height: 35, width: 35, fit: BoxFit.cover),
                    ),
                    8.width,
                    Column(
                ...
                ClipRRect(
                  ...
                  child: commonCachedNetworkImage(data.placeImg!, width: context.width(), height: 190, fit: BoxFit.cover),
                ),
                8.height,
                Row(
                  children: [
