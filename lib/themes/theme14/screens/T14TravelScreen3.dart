                        ...
                        Stack(
                          children: [
                            ClipRRect(
                              ...
                              child: commonCachedNetworkImage(data.img!, width: 180, height: 250, fit: BoxFit.cover),
                            ),
                            8.height,
                            Positioned(
                              top: 8,
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            ClipRRect(
                              ...
                              child: commonCachedNetworkImage(data.userImg!, height: 35, width: 35, fit: BoxFit.cover),
                            ),
                            8.width,
                        ...
                        ClipRRect(
                          borderRadius: BorderRadius.all(Radius.circular(15)),
                          child: commonCachedNetworkImage(data.img!, width: context.width(), height: 350, fit: BoxFit.cover),
                        ),
                      ],
                    ),
                  );
