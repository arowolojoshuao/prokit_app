  ...
  return HorizontalList(
      ...
      itemBuilder: (BuildContext context, int index) {
        return Column(
          ...
          children: [
            commonCacheImageWidget((musicList[index].image), 90, width: 90, fit: BoxFit.cover).cornerRadiusWithClipRRect(8),
            8.height,
...
Widget bottomNavigationWidget() {
  return BottomNavigationBar(
    items: <BottomNavigationBarItem>[
      BottomNavigationBarItem(icon: Icon(MaterialCommunityIcons.music, color: appColorPrimary), label: ''),
      BottomNavigationBarItem(icon: Icon(MaterialCommunityIcons.playlist_music, color: appColorPrimary), label: ''),
      BottomNavigationBarItem(icon: Icon(MaterialCommunityIcons.account, color: appColorPrimary), label: ''),
    ],
