              ...
              children: [
                Container(
                  ...
                  child: Center(
                    child: Text(
                      'All Project',
                      style: primaryTextStyle(color: selectedTab == 'All Project' ? Colors.white : appStore.textPrimaryColor, size: 14),
                    ),
                  ),
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(8),
                  child: Center(child: Text('Illustration', style: primaryTextStyle(color: selectedTab == 'Illustration' ? Colors.white : appStore.textPrimaryColor, size: 14))),
                ).onTap(() {
                  setState(() {
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(8),
                  child: Center(child: Text('Photography', style: primaryTextStyle(color: selectedTab == 'Photography' ? Colors.white : appStore.textPrimaryColor, size: 14))),
                ).onTap(() {
                  setState(() {
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(8),
                  child: Center(child: Text('Website', style: primaryTextStyle(color: selectedTab == 'Website' ? Colors.white : appStore.textPrimaryColor, size: 14))),
                ).onTap(() {
                  setState(() {
                    selectedTab = 'Website';
                    filter(selectedTab);
