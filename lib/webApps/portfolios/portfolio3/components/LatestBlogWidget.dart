                  ...
                  children: getLatestBlogList().map((e) {
                    return Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          commonCachedNetworkImage(e.img!, width: context.width() - 0.35, height: context.height() * 0.35, fit: BoxFit.cover).cornerRadiusWithClipRRectOnly(topLeft: 5, topRight: 5),
                          8.height,
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
