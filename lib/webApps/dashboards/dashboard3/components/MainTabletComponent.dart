...
class MainTabletComponent extends StatefulWidget {
  @override
  MainTabletComponentState createState() => MainTabletComponentState();
}

class MainTabletComponentState extends State<MainTabletComponent> {
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text('Dashboard', style: boldTextStyle(size: 16, color: primaryColor)),
                      2.height,
                      Text('$date', style: primaryTextStyle(size: 12, color: primaryColor)),
                    ],
                  ),
                  Container(
                    height: 40,
              ...
              Container(
                ...
                child: SfCartesianChart(
                  ...
                  title: ChartTitle(text: 'Sales Report', textStyle: boldTextStyle(color: primaryColor)),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('SEE ALL', style: primaryTextStyle(size: 10, color: primaryColor)).onTap(() {
                            ...
                            builder: (context, isHover) {
                              return SettingItemWidget(
                                ...
                                leading: Container(
                                  height: 45,
                                  width: 50,
                                  decoration: boxDecorationWithRoundedCorners(borderRadius: radius(cardRadius), backgroundColor: isHover ? secondaryColor : primaryColor),
                                ...
                                subTitleTextStyle: primaryTextStyle(color: isHover ? white : primaryColor),
                                trailing: Text('\$${e.price}', style: boldTextStyle(color: isHover ? white : primaryColor)),
                              );
                            },
                          );
                        },
