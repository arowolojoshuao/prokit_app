...
class ChoosePlanScreen7State extends State<ChoosePlanScreen7> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget('Pricing plan 7', color: context.scaffoldBackgroundColor),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(planPeriodList[index].optionList![i].title.validate(),
                                          style: boldTextStyle(decoration: planPeriodList[index].optionList![i].isAvailable.validate() ? null : TextDecoration.lineThrough)),
                                      6.height,
                                      Text(
                  ...
                  Align(
                    ...
                    child: AppButton(
                      ...
                      onTap: () {
                        ...
                        snackBar(context, title: "${planPeriodList[index].title}", backgroundColor: appColorPrimary);
                      },
