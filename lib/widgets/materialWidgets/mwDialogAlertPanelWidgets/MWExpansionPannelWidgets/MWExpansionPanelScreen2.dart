...
class MWExpansionPanelScreen2 extends StatefulWidget {
  const MWExpansionPanelScreen2({Key? key}) : super(key: key);

  @override
  _MWExpansionPanelScreen2State createState() => _MWExpansionPanelScreen2State();
}

class _MWExpansionPanelScreen2State extends State<MWExpansionPanelScreen2> {
  bool isExpanded = false;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(context, 'Expansion Panel 2 '),
