      ...
      child: Column(
        children: <Widget>[
          ClipRRect(
            ...
            child: commonCachedNetworkImage(model.img, fit: BoxFit.cover, height: 75, width: 75),
          ),
          SizedBox(height: 4),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ClipRRect(
            borderRadius: BorderRadius.circular(12.0),
            child: commonCachedNetworkImage(model.img, fit: BoxFit.cover, height: 170, width: MediaQuery.of(context).size.width),
          ),
          SizedBox(height: 4),
          Padding(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Card(
        ...
        child: commonCachedNetworkImage(file, fit: BoxFit.fill),
      ),
    );
  }
}
